        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-[var(--forest-900)] text-[var(--sage-tint)] opacity-80 uppercase tracking-widest text-xs font-bold">Or continue with</span>
            </div>
          </div>
          ...
          <div>
            <button
              ...
              className="group relative w-full flex justify-center py-3 px-4 border border-[var(--border-subtle)] text-sm font-bold tracking-widest rounded-md text-[var(--ink-50)] bg-white/5 hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[var(--gold-400)] focus:ring-offset-[var(--forest-900)] transition-all shadow-lg hover:shadow-xl"
            >
